...
INSERT INTO taxonomy_labels (domain_code,value_code,label_fa) VALUES
  ...
  ('character_role','cafe_staff','کارمند کافه'),
  ...
  ('relationship_tag','neighbor','همسایه'),
  ('relationship_tag','acquaintance','آشنا'),
...
CREATE TABLE IF NOT EXISTS provenance_links (
  ...
  transformation ENUM('verbatim','persian_translation_added','sentence_tokenized_for_word_order','source_sentence_blank_created','source_items_grouped_for_matching','options_selected_from_source_material','source_items_grouped_for_pronunciation','character_metadata_added','cefr_level_assigned_by_app','other') NULL,
  notes TEXT NULL,
  PRIMARY KEY (id),
