...
SET status='final',
    ...
    completion_assessment=JSON_OBJECT(
      ...
      'qualityReview',JSON_OBJECT(
        ...
        'remainingWeaknesses',JSON_ARRAY(
          ...
          'Audio هنوز تولید نشده و کیفیت شنیداری نهایی پس از تولید و اعتبارسنجی فایل‌ها باید جداگانه کنترل شود.'
        )
      ),
    ...
    notes='A1 از نظر محتوایی نهایی شده است: هر ۱۰ واحد و هر ۱۶ درس نهایی‌اند، همهٔ ۳۷ هدف الزامی پوشش و ارزیابی شده‌اند و شکاف الزامی باز باقی نمانده است. Audio اکنون از حالت مسدود خارج شده و در وضعیت pending قرار دارد؛ هنوز هیچ TTS پولی تولید نشده است.'
WHERE id=@level;
