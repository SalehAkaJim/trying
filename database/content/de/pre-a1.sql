...
UPDATE lessons SET title_fa='بله یا نه؟', source_title='Magst du Pizza? / ja / nein', source_title_fa='بله یا نه؟', status='final', activity_selection_rationale='مکالمهٔ چهار نوبت این بار با زبان‌آموز شروع می‌شود تا سؤال آشنا را فعالانه بپرسد؛ سپس انتخاب پاسخ تفاوت «ja» و «nein» را تمرین می‌کند.', sequence_rationale='اول زبان‌آموز نقش آغازکننده و پرسشگر را می‌گیرد، سپس پاسخ مثبت و منفی را در همان بافت تشخیص می‌دهد.', template_signature='conversation_speaking>choose_response', audio_status='pending' WHERE lesson_key='de-pre-a1-lesson-ja-nein';
...
UPDATE lessons SET title_fa='کجا زندگی می‌کنی؟', source_title='Wo wohnen Sie? / Woher kommen Sie?', source_title_fa='کجا زندگی می‌کنی؟', status='final', activity_selection_rationale='همان مکالمهٔ کوتاه هدف این درس را پوشش می‌دهد و تمرین اضافه فقط تکرار ایجاد می‌کند.', sequence_rationale='ابتدا محل زندگی و سپس مبدأ در یک آشنایی مؤدبانه مطرح می‌شود.', template_signature='conversation_speaking', audio_status='pending' WHERE lesson_key='de-pre-a1-lesson-residence-origin';
